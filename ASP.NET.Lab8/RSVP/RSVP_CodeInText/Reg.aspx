...
<asp:Content ID="RegContent" ContentPlaceHolderID="ContentPlaceHolderMainRight" runat="server"> 
    ...
    <div>
        ...
        <asp:TextBox ID="TextBoxTitle1" runat="server" Width="345px"></asp:TextBox>
    </div>
    <div>
        Введите аннотацию доклада #1:
        <asp:TextBox ID="TextBoxAnnotation1" runat="server" Width="345px"></asp:TextBox>
    </div>
    <div>
    ...
    <div>
        ...
        <asp:TextBox ID="TextBoxAnnotation2" runat="server" Width="345px"></asp:TextBox>
    </div>
    <div>
